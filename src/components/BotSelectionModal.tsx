...
interface BotSelectionModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSelectBot: (bot: 'gemini' | 'showai') => void;
}
            ...
            >
                <motion.div
                    {...{
                        ...
                        transition: { duration: 0.3 },
                        className: "bg-[#0F172A] rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 border border-[#3E52E8]/20"
                    } as ModalBackdropProps}
                >
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-bold text-white">Chọn Trợ Lý AI</h2>
                        <button
                            onClick={onClose}
